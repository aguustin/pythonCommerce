...
const UpdateProductForm = () => {
    const {updateForm, visibleForm, setVisibleForm, previousStock, handleProductNameContext, handleProductDescriptionContext, handleProductPriceContext, handleProductQuantityContext, handleProductCategoryContext} = useContext(ProductsContext)
        ...
        <> 
            ...
            <form className='addProductForm' onSubmit={(e) => updateProduct(e)}>
                ...
                <div className="d-flex items-center justify-content-between">
                    ...
                    <button type="button" onClick={() => setVisibleForm(!visibleForm)}>Cancel</button>
                </div>
            </form>
        </>
    )
